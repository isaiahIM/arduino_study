...
void loop() {
  ...
  if(g_curTime_us-g_prevTime_us>=2400)
  {
      ...
      Digit^=1;
      DisplayFont(g_DotMatrix_Row, g_DotMatrix_Col, COL, g_ShiftFont[(g_KeyReadRow*KEY_COL)+g_KeyReadCol], g_MicroCount);
  ...
  {
      Tone(SpeakerPin, g_Melody[g_melodyCount], 250, g_curTime_us, &g_LastSoundTime_us);
  }
  else
  {
